...
var tasks = [
    ...
    new __WEBPACK_IMPORTED_MODULE_1__task__["a" /* Task */]('Zwischendominanten', function () {
        var note = __WEBPACK_IMPORTED_MODULE_0__toggle_chunk_chunks__["a" /* chunks */].notes.randomItem();
        var steps = ['I', 'II', 'III', 'IV', 'V', 'VI', 'VII'];
        var step = steps[Math.floor(Math.random() * steps.length)];
        return (Math.random() > .7 ? 'Sub' : '') + "V/" + step + " in " + note + " dur";
    }, [__WEBPACK_IMPORTED_MODULE_0__toggle_chunk_chunks__["a" /* chunks */].notes.pool]),
    new __WEBPACK_IMPORTED_MODULE_1__task__["a" /* Task */]('Zwischendominanten moll', function () {
        var note = __WEBPACK_IMPORTED_MODULE_0__toggle_chunk_chunks__["a" /* chunks */].notes.randomItem();
        var steps = ['I', 'II', 'bIII', 'IV', 'V', 'bVI', 'bVII'];
        var step = steps[Math.floor(Math.random() * steps.length)];
        return (Math.random() > .7 ? 'Sub' : '') + "V/" + step + " in " + note + " dur";
    }, [__WEBPACK_IMPORTED_MODULE_0__toggle_chunk_chunks__["a" /* chunks */].notes.pool]),
];
